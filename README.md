...
To manage this external package we will use composer, be sure to first read [the documentation about composer](composer.md) and install both composer and then Monolog.
